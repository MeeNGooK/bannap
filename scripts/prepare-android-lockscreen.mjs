...
if (!manifest.includes('BannapNotificationActionReceiver')) {
  manifest = manifest.replace('</application>', '        <receiver android:name=".BannapNotificationActionReceiver" android:exported="false" />\n    </application>');
}
